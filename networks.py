...
class UnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, num_downs, nhf=64, norm_type='none', use_dropout=False, output_function='sigmoid'):
...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None, submodule=None, outermost=False, innermost=False, norm_layer=nn.BatchNorm2d, use_dropout=False, output_function='sigmoid'):
...
class RevealNet(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, nrf=64, norm_type='none', output_function='sigmoid'):
