...
class rgb_to_ycbcr_jpeg(nn.Module):
    ...
    Outpput:
        result(tensor) -- batch * height * width * 3
    """
    def __init__(self):
...
class chroma_subsampling(nn.Module):
    ...
    Input:
        image(tensor) -- batch * height * width * 3
    Output:
        y(tensor)  -- batch * height   * width
        cb(tensor) -- batch * height/2 * width/2
        cr(tensor) -- batch * height/2 * width/2
    """
    def __init__(self):
...
class block_splitting(nn.Module):
    ...
    Output: 
        patch(tensor) -- batch * height*width/64 * height * width
    """
    def __init__(self):
...
class compress_jpeg(nn.Module):
    ...
    Input:
        imgs(tensor)       -- batch * 3 * height * width
        rounding(function) -- rounding function to use
        factor(float)      -- compression factor
    Ouput:
        compressed(dict(tensor)) -- batch * height*width/64 * 8 * 8
    """
...
class block_merging(nn.Module):
    ...
    Inputs:
        patches(tensor) -- batch * height*width/64 * height * width
...
class chroma_upsampling(nn.Module):
    ...
    Input: 
        ...
        cb(tensor) -- cb channel image
        cr(tensor) -- cr channel image
    Ouput:
        image(tensor) -- batch * height * width * 3
    """
    def __init__(self):
...
class ycbcr_to_rgb_jpeg(nn.Module):
    ...
    Input:
        image(tensor) -- batch * height * width * 3
    Outpput:
        result(tensor) -- batch * 3 * height * width
    """
    def __init__(self):
...
class decompress_jpeg(nn.Module):
    ...
    Input:
        compressed(dict(tensor)) -- batch * h*w/64 * 8 * 8
        rounding(function)       -- rounding function to use
        factor(float)            -- compression factor
    Ouput:
        image(tensor) -- batch * 3 * height * width
